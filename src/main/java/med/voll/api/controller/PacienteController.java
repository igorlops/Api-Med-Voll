...
import med.voll.api.paciente.DadosPacienteCadastrados;
...
public class PacienteController{
    ...
    @PostMapping
    @Transactional
    public ResponseEntity cadastrar(@RequestBody @Valid DadosPacienteCadastrados dados,UriComponentsBuilder uriBuilder){
